...
A Go program to identify and list files duplicated between monthly directories (`YYYYMM`) and a specific subdirectory named `not_google` within the same month, storing the results in a text file.
